from flpoison.utils.global_utils import import_all_modules, Register
import os
from flpoison.fl.models.vgg import add_vgg_from_torchvision

model_registry = Register()
import_all_modules(os.path.dirname(__file__), package_name=__name__)
